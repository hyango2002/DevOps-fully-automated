...
2) ###### Jenkins/Maven/Ansible
    ...
    - User data (Copy the following user data): https://github.com/hyango2002/devops-fully-automated-scripts/blob/main/jenkins-maven-ansible-setup.sh
    - Launch Instance
...
6) ###### Prometheus
    ...
    - User data (Copy the following user data): https://github.com/hyango2002/devops-fully-automated-scripts/blob/main/prometheus-setup.sh
    - Launch Instance
